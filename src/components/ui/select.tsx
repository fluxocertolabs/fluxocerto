...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-md border bg-popover text-popover-foreground shadow-md origin-[--radix-select-content-transform-origin] will-change-[transform,opacity] data-[state=open]:animate-[fc-select-open_280ms_cubic-bezier(0.16,1,0.3,1)] data-[state=closed]:animate-[fc-select-close_200ms_cubic-bezier(0.4,0,0.2,1)]",
        position === "popper" &&
          "data-[side=bottom]:mt-1 data-[side=top]:mb-1 data-[side=left]:mr-1 data-[side=right]:ml-1",
        className
      )}
      position={position}
      {...props}
